...
dt = np.load('loss_experiments/resnet18_adaptive_losses.npy')
(train_losses, train_r2, val_losses, val_r2) = dt
x_data = np.arange(700)
...
plt.xlabel('Number of Epochs')
plt.ylabel('Loss')
plt.savefig('loss_experiments/resnet18_regression_loss_plots')
...
plt.xlabel('r2')
plt.ylabel('Accuracy')
plt.savefig('loss_experiments/resnet18_regression_r2_plots')