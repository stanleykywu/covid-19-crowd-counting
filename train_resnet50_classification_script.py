...
from models import ResNet50Classification
...
torch.save(model, 'saved_models/resnet50_classification')
np.save(f"loss_experiments/resnet50_classification_losses", (train_losses, train_accuracies, val_losses, val_accuracies))
