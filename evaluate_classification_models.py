...
def main(args):
    ...
    train_f1 = f1_score(train_vgg16_actual, train_vgg16_predictions, average='samples')
    val_f1 = f1_score(val_vgg16_actual, val_vgg16_predictions, average='samples')
    test_b_f1 = f1_score(test_b_vgg16_actual, test_b_vgg16_predictions, average='samples')
    test_ub_f1 = f1_score(test_ub_vgg16_actual, test_ub_vgg16_predictions, average='samples')
